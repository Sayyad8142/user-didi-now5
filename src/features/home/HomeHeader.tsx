      ...
      <div className="p-4 flex justify-between items-center gap-4">
        ...
        <div className="text-right flex-shrink-0 min-w-0">
          <button
            ...
            className="inline-flex items-center gap-1 mb-1 text-[11px] font-semibold text-emerald-700 bg-emerald-50 border border-emerald-200 rounded-full px-2 py-0.5 ml-auto"
          >
