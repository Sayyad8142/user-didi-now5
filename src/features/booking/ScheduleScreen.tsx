          ...
          <div className="mt-4 p-4 bg-gradient-to-r from-primary/5 to-primary/10 rounded-2xl border border-primary/20">
            <div className="space-y-1.5">
              ...
              {selectedTime && getSurge(selectedTime) > 0 && (
                <div className="flex items-center justify-between">
                  <span className="text-xs text-orange-600">Peak-time charge</span>
          ...
          >
            {submitting ? (
              <div className="flex items-center gap-2">
                ...
                <span>
                  {paymentStatus === 'debiting_wallet' && 'Checking wallet...'}
                  {paymentStatus === 'processing_wallet_booking' && 'Deducting wallet and creating booking...'}
