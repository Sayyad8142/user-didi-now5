        ...
        <Card className="border border-border rounded-2xl">
          ...
          <div className="mt-8 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              {/* Choose Fav Worker Card - beside Instant */}
              {isServiceOpen && !instantDisabled ? (
                <button
                  ...
                  className={cn(
                    "relative flex flex-col items-start gap-3 p-4 rounded-2xl border-2 shadow-sm transition-all duration-200 text-left",
                    "hover:shadow-md active:scale-[0.98]",
                    preferredWorker ? "border-primary/40 bg-primary/5" : "border-border bg-card hover:border-primary/40"
                  )}
                >
                  {preferredWorker ? (
                    <>
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="font-bold text-foreground text-sm truncate">{preferredWorker.full_name}</p>
                    ...
                    <>
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="font-bold text-primary text-sm leading-tight">Choose your fav worker</div>
                      </div>
                      <ChevronRight className="w-4 h-4 text-muted-foreground absolute top-4 right-4" />
                    </>
                  )}
