...
-- 11. Patch auto_cancel_stale_instant_bookings to set cancellation_reason = 'no_worker_found'
--     so wallet refund trigger uses the correct reason in wallet_transactions
